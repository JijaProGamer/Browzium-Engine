class ATrousDenoiser {
    ...
    makePipelines() {
        const shader = this.parent.device.createShaderModule({ code: this.parent.opts.shaders.path_traced.denoisers.atrous, label: "Browzium engine compute shader atrous denoiser code" });
        ...
        let pipelineLayout = this.parent.device.createPipelineLayout({
            bindGroupLayouts: [this.holder.computeDataLayout, this.computeImageLayout, this.computeFilteringDataLayout],
    ...
    async #runLevel(level) {
        ...
        passEncoder.setBindGroup(0, this.holder.computeDataBindGroup);
    ...
    #copyTracedData() {
        ...
        copyEncoder.copyTextureToTexture(
            {
                texture: this.holder.renderTextureNormal,
            },
            {
        ...
        copyEncoder.copyTextureToTexture(
            {
                texture: this.holder.renderTextureDepth,
            },
            {
        ...
        copyEncoder.copyTextureToTexture(
            {
                texture: this.holder.renderTextureObject,
            },
            {
