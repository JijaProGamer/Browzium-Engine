class emptyDenoiser {
    ...
    makePipelines() {
        const shader = this.parent.device.createShaderModule({ code: this.parent.opts.shaders.denoisers.none, label: "Browzium engine compute shader none denoiser code" });
